          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _CategoryChip("Pantry", Icons.kitchen, const Color(0xFFF59E0B), onTap: () => widget.onOpenInventory?.call('Pantry')),
                _CategoryChip("Beverages", Icons.local_drink, const Color(0xFF38BDF8), onTap: () => widget.onOpenInventory?.call('Beverages')),
                _CategoryChip("Toiletries", Icons.spa, const Color(0xFF8B5CF6), onTap: () => widget.onOpenInventory?.call('Toiletries')),
                _CategoryChip("Household Items", Icons.home_outlined, const Color(0xFF14B8A6), onTap: () => widget.onOpenInventory?.call('Household Items')),
